...
# Serializes the check-then-insert critical section (create) and the
# status-recheck-then-commit critical section (cancel) so the no-double-booking,
# quota, and single-cancel invariants hold under concurrent requests.
